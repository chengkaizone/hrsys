...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "smile.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "smile.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "smile.mail.routing.key";
